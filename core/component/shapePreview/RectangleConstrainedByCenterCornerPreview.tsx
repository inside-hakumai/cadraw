...
interface Props {
  shape: RectangleSeedConstrainedByCenterCorner
}

const RectangleConstrainedByCenterCornerPreview: React.FC<Props> = ({ shape }) => {
...
export default RectangleConstrainedByCenterCornerPreview
